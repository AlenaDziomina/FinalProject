...
class DirectionQuery implements TypedQuery<Direction>{
    ...
    @Override
    public List<Integer> save(List<Direction> beans, GenericSaveQuery saveGeneric, Connection conn) throws DaoQueryException {
        try {
            return saveGeneric.sendQuery(SAVE_QUERY, conn, Params.fill(beans, (Direction bean) -> {
